    ...
    public void statistics() {
        ...
        try {
            ...
            for (CompetitionEnum value : CompetitionEnum.values()) {
                ...
                Map<String, HeroLandStatisticsDetailDP> mergeMap = totalSyncTotalScore.stream().filter(v -> v.getUserId().length() > 15).collect(Collectors.toMap(this::fetchUserKey, Function.identity(), (o, n) -> n));
